...
export function Header({ onOpenHelp, onOpenStats }: HeaderProps) {
  return (
    <header className="w-full h-12 flex items-center justify-between px-4 border-b border-[#3A3A3C] bg-[#121213] sticky top-0 z-10">
      <button onClick={onOpenHelp} className="w-8 h-8 flex items-center justify-center text-[#818384] hover:text-white transition-colors" aria-label="How to play">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
      </button>
      
      <Link href="/" className="font-playfair font-bold text-2xl text-white tracking-wide hover:opacity-80 transition-opacity">
        VERSICULUS
      </Link>
      
      <div className="flex gap-2">
        <button onClick={onOpenStats} className="w-8 h-8 flex items-center justify-center text-[#818384] hover:text-white transition-colors" aria-label="Statistics">
        ...
        <button className="w-8 h-8 flex items-center justify-center text-[#818384] hover:text-white transition-colors" aria-label="Settings">
